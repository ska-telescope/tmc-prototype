...
python3 -m pip install --index-url https://nexus.engageska-portugal.pt/repository/pypi/simple ska-logging==0.3.0 lmcbaseclasses==0.7.2 ska-telescope-model==0.1.4
python3 -m pip install --index-url https://artefact.skao.int/repository/pypi-internal/simple  cdm-shared-library==2.0.0 ska-tmc-common==0.1.7+d39e6423
