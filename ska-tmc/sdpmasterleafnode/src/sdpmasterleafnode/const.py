...
STR_TELESCOPE_ON_CMD_SUCCESS = "TELESCOPEON command invoked successfully from SDP Master leaf node."
STR_ON_CMD_SUCCESS = "ON command invoked successfully from SDP Master leaf node."
STR_OFF_CMD_SUCCESS = "OFF command invoked successfully from SDP Master leaf node."
STR_STANDBY_CMD_SUCCESS = "Standby command invoked successfully from SDP Master leaf node."
STR_TELESCOPE_OFF_CMD_SUCCESS = "TELESCOPEOFF command invoked successfully from SDP Master leaf node."
...
ERR_TELESCOPE_OFF_CMD_FAIL = "Failed to invoke TelescopeOff command on SdpMasterLeafNode."
ERR_TELESCOPE_ON_CMD_FAIL = "Failed to invoke TelescopeOn command on SdpMasterLeafNode."
...
ERR_TELESCOPE_STANDBY_CMD_FAIL = "Failed to invoke TelescopeStandby command on SdpMasterLeafNode."
