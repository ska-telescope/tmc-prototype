...
class OverrideSdpSubarray(object):
    ...
    def action_assignresources(self, model, tango_dev=None, data_input=None):# pylint: disable=W0613
        ...
        if (obsstate == "EMPTY"):
            ...
            enum_int = get_enum_int(obsstate_attribute,"RESOURCING")
            ...
            enum_int = get_enum_int(obsstate_attribute,"IDLE")
            tango_dev.push_change_event("obsState", enum_int)
        ...
        return (ResultCode.OK, "Assign resource successful on simulator.")
    ...
    def action_endscan(self, model, tango_dev=None, data_input=None):# pylint: disable=W0613
        ...
        if (obsstate == "SCANNING"):
            ...
            enum_int = get_enum_int(obsstate_attribute,"READY")
            tango_dev.push_change_event("obsState", enum_int)
        ...
        return (ResultCode.OK, "EndScan successful on simulator.")
    ...
    def action_abort(self, model, tango_dev=None, data_input=None):# pylint: disable=W0613
        ...
        if (obsstate in _allowed_obsstate):
            ...
            enum_int = get_enum_int(obsstate_attribute,"ABORTING")
            tango_dev.push_change_event("obsState", enum_int)
            ...
            enum_int = get_enum_int(obsstate_attribute,"ABORTED")
            tango_dev.push_change_event("obsState", enum_int)
    ...
    def action_releaseresources(self, model, tango_dev=None, data_input=None):# pylint: disable=W0613
        """Changes the State of the device to .
        """
        obsstate_attribute = model.sim_quantities['obsState']
        obsstate = get_enum_str(obsstate_attribute)
        if (obsstate == "IDLE"):
            ...
            enum_int = get_enum_int(obsstate_attribute,"EMPTY")
            tango_dev.push_change_event("obsState", enum_int)
        ...
        return (ResultCode.OK, "Release_all_resource successful on simulator.")
    ...
    def action_configure(self, model, tango_dev=None, data_input=None):# pylint: disable=W0613
        ...
        if (obsstate in _allowed_obsstate):
            ...
            enum_int = get_enum_int(obsstate_attribute,"CONFIGURING")
            tango_dev.push_change_event("obsState", enum_int)
    ...
    def action_scan(self, model, tango_dev=None, data_input=None):# pylint: disable=W0613
        ...
        if (obsstate == "READY"):
            ...
            enum_int = get_enum_int(obsstate_attribute,"SCANNING")
            tango_dev.push_change_event("obsState", enum_int)
    ...
    def action_end(self, model, tango_dev=None, data_input=None):# pylint: disable=W0613
        """Changes the State of the device to .
        """
        obsstate_attribute = model.sim_quantities['obsState']
        obsstate = get_enum_str(obsstate_attribute)
    ...
    def action_restart(self, model, tango_dev=None, data_input=None):# pylint: disable=W0613
        ...
        return (ResultCode.OK, "Restart command successfull on simulator.")
    ...
    def action_obsreset(self, model, tango_dev=None, data_input=None): # pylint: disable=W0613
        ...
        return (ResultCode.OK, "ObsReset command successfull on simulator.")
