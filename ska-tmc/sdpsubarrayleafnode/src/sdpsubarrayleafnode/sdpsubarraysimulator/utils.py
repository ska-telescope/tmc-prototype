...
def get_tango_server_class(device_name):
    ...
    sim_data_files.append(
        pkg_resources.resource_filename("sdpsubarrayleafnode.sdpsubarraysimulator", "SdpSubarray.fgo")
    )
    sim_data_files.append(
        pkg_resources.resource_filename("sdpsubarrayleafnode.sdpsubarraysimulator", "sdp_subarray_SimDD.json")
    )
