...
ERR_RESET_INVOKING_CMD = "Error while invoking Reset command on SDP SubarrayLeafNode."
...
STR_RESET_SUCCESS = "Reset command is invoked successfully on SDP SubarrayLeafNode."
