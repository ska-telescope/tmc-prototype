...
release_filename = os.path.join(setup_dir, "src", "ska_tmc_sdpsubarrayleafnode_mid", "release.py")
...
setup(
    ...
    entry_points={
        "console_scripts": [
            "SdpSubarrayLeafNodeDS = ska_tmc_sdpsubarrayleafnode_mid.sdp_subarray_leaf_node:main"
        ]
    },
    author="Team NCRA",
