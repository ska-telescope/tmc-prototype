...
ERR_DEVICE_NOT_IN_STATE = "SdpSubarray is not in SCANNING,CONFIGURING.READY,IDLE state."
ERR_DEVICE_NOT_IN_FAULT_ABORTED = "SdpSubarray is not in FAULT,ABORTED state."
