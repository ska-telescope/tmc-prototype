...
class StartUpTelescope(SKABaseDevice.OnCommand):
    ...
    def do(self):
        ...
        try:
            ...
            event_id=csp_mln_client.subscribe_event(const.EVT_SUBSR_CSP_MASTER_HEALTH,
                                                          EventType.CHANGE_EVENT,
                                                          health_cb.do(), stateless=True)
        ...
        try:
            ...
            tango.Except.throw_exception(const.STR_ON_EXEC, log_msg,
                                         ...
                                         tango.ErrSeverity.ERR)
        try:
            for subarrayID in range(1, len(device_data.tm_subarray_client) + 1):
