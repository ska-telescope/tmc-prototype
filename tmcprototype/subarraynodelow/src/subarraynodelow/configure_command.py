...
class ConfigureCommand(SKASubarray.ConfigureCommand):
    ...
    def do(self, argin):
        ...
        # The configuration data for SDP, CSP and Dish is
...
class ElementDeviceData:
    ...
    # @staticmethod
    # def build_up_mccs_subarray_cmd_data(scan_config):
    #     mccs_scan_config = scan_config.get("StationBeamPointingList", {})
    #     if not mccs_scan_config:
