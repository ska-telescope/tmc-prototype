...
python3 -m pip install --index-url https://nexus.engageska-portugal.pt/repository/pypi/simple ska-logging==0.3.0 lmcbaseclasses==0.7.2 cdm-shared-library==2.0.0 ska-telescope-model==0.1.4 skatmccommon==0.1.1+4fba2733
