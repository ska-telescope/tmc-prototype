...
coverage combine dishleafnode_coverage cspmasterleafnode_coverage \
	 ...
	 subarraynode_coverage centralnode_coverage centralnodelow_coverage  && coverage xml && coverage html
...
junitparser merge /report/unit_test/dishleafnode-unit-tests.xml \
                ...
                /report/unit_test/centralnodelow-unit-tests.xml-unit-tests.xml \
