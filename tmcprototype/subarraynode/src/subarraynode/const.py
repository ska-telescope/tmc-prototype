...
STR_ASSIGN_RESOURCES_INV_SDP_SALN = "Assign Resources is invoked on SDP Subarray Leaf Node"
STR_RELEASE_ALL_RESOURCES_CSP_SALN = "ReleaseAllResources command is invoked on CSP Subarray Leaf Node"
STR_RELEASE_ALL_RESOURCES_SDP_SALN = "ReleaseAllResources command is invoked on SDP Subarray Leaf Node"
