...
CMD_TRACK = "Track"
CMD_STOP_TRACK = "Command StopTrack is invoked on Dish Leaf Nodes Group"
...
CMD_ENDSB = "Command EndSB is invoked on SDP Subarray Leaf Node."
CMD_GOTOIDLE = "Command GoToIdle is invoked on CSP Subarray Leaf Node."
