...
#                 lrcr_callback=self.component_manager.
# long_running_result_callback,
#             )
...
#         Example:
#            "sdp":{"interface":"https://schema.skao.int/ska-sdp-assignres/
# 0.4","execution_block": {"eb_id":
#         "eb-mvp01-20200325-00001","max_length": 100,"context":{},"beams":
# [{"beam_id": "vis0",
...
# [{"spectral_window_id":
#         "fsp_1_channels","count": 744,"start": 0,"stride": 2,"freq_min":
# 350000000,"freq_max":
...
# "zoom_window_1","count": 744,"start":
#         4000,"stride": 1,"freq_min": 360000000,"freq_max": 361000000,
# "link_map": [[4000,6],[4200,7]]}]},
#         {"channels_id":"pulsar_channels","spectral_windows":
# [{"spectral_window_id":
#         "pulsar_fsp_channels","count": 744,"start": 0,"freq_min": 350000000,
# "freq_max": 368000000}]}],
#         "polarisations": [{"polarisations_id": "all","corr_type":["XX","XY",
# "YY","YX"]}],"fields":
#         [{"field_id": "field_a","phase_dir":{"ra":[123,0.1],"dec":[123,0.1],
# "reference_time": "...",
#         "reference_frame": "ICRF3"},"pointing_fqdn":
# "low-tmc/telstate/0/pointing"}]},
#         "processing_blocks":[{"pb_id": "pb-mvp01-20200325-00001",
# "sbi_ids":["sbi-mvp01-20200325-00001"],
#         "script":{},"parameters":{},"dependencies":{}},{"pb_id":
# "pb-mvp01-20200325-00002","sbi_ids":
...
#         "script":{},"parameters": {},"dependencies":{}}],"resources":
# {"csp_links":[1,2,3,4],
...
#                     self.sdp_subarray_adapter.dev_name
#                 )
#                 + "Reason: Error in calling the AssignResources command
# on Sdp"
#                 + "Subarray."
