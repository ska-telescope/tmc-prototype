...
release_filename = os.path.join(setup_dir, "src", "ska_tmc_centralnode_low", "release.py")
...
setup(
    ...
    entry_points={
        "console_scripts": ["CentralNodeLowDS=ska_tmc_centralnode_low.central_node_low:main"]
    },
    author="Team NCRA",
