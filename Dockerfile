...
RUN python3 -m pip install https://nexus.engageska-portugal.pt/repository/pypi/packages/cdm-shared-library/0.1.34+dev.65694be4/cdm-shared-library-0.1.34+dev.65694be4.tar.gz
