...
PYTHONPATH=/home/tango/ska-tmc/:/home/tango/ska-tmc/post-deployment/:
...
tp_pip:
	...
	@echo "##########################";
	kubectl exec -it $(testing-pod) --namespace $(KUBE_NAMESPACE) -- bash -c "/usr/bin/python3 -m pip install -r /home/tango/ska-tmc/post-deployment/test_requirements.txt"
...
install_web_dependencies:
	...
	@echo "##########################";
	kubectl exec -it $(testing-pod) --namespace $(KUBE_NAMESPACE) -c web-pytest -- bash -c "/usr/bin/python3 -m pip install -r /home/tango/ska-tmc/post-deployment/test_requirements.txt"
...
clean_ska-tmc: # remove any cache or build files on repo created during testing and build jobs
...
get_web_shell:
	...
	#-- bash -c "cd /home/tango/ska-tmc/post-deployment/exploration/web_pytest/ && python3 web_pytest.py"
