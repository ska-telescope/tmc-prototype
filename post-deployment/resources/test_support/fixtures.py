...
from resources.test_support.event_waiting import (
    sync_telescope_shutting_down,
    watchSpec,
    sync_telescope_starting_up,
    sync_subarray_assigning,
    sync_subarray_releasing,
    sync_subarray_configuring,
    sync_release_configuration,
)
...
def assert_subarray_is_idle(id):
    resource(f"ska_mid/tm_subarray_node/{id}").assert_attribute("obsState").equals(
        "IDLE"
    )
...
## pytest fixtures
ENV_VARS = ["HELM_RELEASE", "KUBE_NAMESPACE", "TANGO_HOST", "MARK"]
...
class K8_env:
    ...
    def __init__(self, run_context: RunContext) -> None:
        ...
        # Only run this block of code in case of TMC mid deployment
