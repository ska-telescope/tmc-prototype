# pylint: disable = W0201, W0223, C0114, C0115, C0116, W0622, W1203, W0221,
import json
...
class HelperSubArrayDevice(SKASubarray):
    ...
    class InitCommand(SKASubarray.InitCommand):
        def do(self):
            super().do()
            device = self.target
            device._receive_addresses = '{"science_A":{"host":[\
                [0,"192.168.0.1"],[2000,"192.168.0.1"]],"port":\
                    [[0,9000,1],[2000,9000,1]]}}'
