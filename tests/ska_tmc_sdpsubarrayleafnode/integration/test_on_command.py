...
def on_command(tango_context, sdpsaln_fqdn, sdpsa_fqdn, change_event_callbacks):
...
def test_on_command_mid(tango_context, change_event_callbacks):
    on_command(
        tango_context, SDP_SUBARRAY_LEAF_NODE_MID, SDP_SUBARRAY_DEVICE_MID, change_event_callbacks
    )
...
def test_on_command_low(tango_context, change_event_callbacks):
    on_command(
        tango_context, SDP_SUBARRAY_LEAF_NODE_LOW, SDP_SUBARRAY_DEVICE_LOW, change_event_callbacks
    )
